A five-star health system funded like a two-star one. This episode opens the
dossier behind that contradiction — *Puerto Rico Built the Case, PRFAA Built
the Coalition* — and walks through the playbook that turned a broken actuarial
formula into the August 2026 letter in which 13 House Republicans, led by
physician Rep. Greg Murphy, demanded that CMS fix its own math.

In this episode:

- **The paradox in the government's own data.** CMS star ratings crown Puerto
  Rico's Medicare Advantage market among the nation's best — while the payment
  benchmark sits roughly **41% below the national average**, and even below
...
- **The case.** Governor Jenniffer González-Colón's February 2026 letter to
...
- **The letter.** Why Rep. Greg Murphy — a surgeon and co-chair of the GOP
  ...
  and led 13 House Republicans to challenge the CMS formula for Puerto Rico.
- **The warning for the mainland.** Saturated MA markets in Florida, Arizona
  and Southern California are trending toward the same mathematical
  singularity. Puerto Rico is the canary in the coal mine — a decade early.

The closing question: when a system that claims to reward value starves the
